...
void setup()
{
	...
	DCCpp.begin();
	DCCpp.beginMain(UNDEFINED_PIN, 12, 50, A5);
	//DCCpp.beginProg(UNDEFINED_PIN, MOTOR_SHIELD_DIRECTION_MOTOR_CHANNEL_PIN_B, MOTOR_SHIELD_SIGNAL_ENABLE_PIN_PROG, MOTOR_SHIELD_CURRENT_MONITOR_PIN_PROG);
